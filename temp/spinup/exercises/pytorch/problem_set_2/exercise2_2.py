from temp.spinup.algos.pytorch.ddpg import mlp, MLPActorCritic
from temp.spinup.utils import ExperimentGrid
...
if __name__ == '__main__':
    ...
    def ddpg_with_actor_critic(bugged, **kwargs):
        from temp.spinup.exercises.pytorch.problem_set_2.exercise2_2 import BuggedMLPActorCritic
